import{$ as Jz,An as cn,E as Eb,En as ba,G as It,Ht as WA,Jn as fv,Ln as ed,Mn as dg,Nn as di,Qn as gv,Un as fg,Yn as g$1,Zr as sv,_r as le,a as $d,an as Yv,br as lv,cr as iv,d as Ax,dr as jS,f as Ba,fn as Zd,ft as Oe,gn as _D,ht as PS,li as v,lt as LS,r as $a,rn as Yd,rt as Kd,v as Cs,vr as li,yi as xv,yr as ln,zt as Ve}from"./chunk-C8wGf5gp.js";import{B as gt,H as lc,L as ct,c as De,tt as ze,w as Pi}from"./chunk-Bxgb2Ach.js";var Y=[`*`];var J=(()=>{class t{labelPosition=`after`;static ɵfac=function(n){return new(n||t)};static ɵcmp=li({type:t,selectors:[[``,`mat-internal-form-field`,``]],hostAttrs:[1,`mdc-form-field`,`mat-internal-form-field`],hostVars:2,hostBindings:function(n,c){n&2&&Ba(`mdc-form-field--align-end`,c.labelPosition===`before`)},inputs:{labelPosition:`labelPosition`},ngContentSelectors:Y,decls:1,vars:0,template:function(n,c){n&1&&(Yd(),Kd(0))},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return t})();var ve=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=ln({type:t});static ɵinj=It({imports:[te,_D]})}return t})();export{ve as n,te as t};